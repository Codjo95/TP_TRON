	...
	<header class="header-section clearfix">
		<div class="container-fluid">
			<a href="index.html" class="site-logo">
				<img src="img/10-removebg-preview.png" alt="" width="200PX">
			</a>
			<div class="responsive-bar"><i class="fa fa-bars"></i></div>
			<a href="" class="user"><i class="fa fa-user"></i></a>
			<a href="" class="site-btn">MON COMPTE</a>
			<nav class="main-menu">
				<ul class="menu-list">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 hero-text">
					<h2>Gagnez chaque jour des <span>TRON</span> <br>avec TP-TRON</h2>
					<h4>Decouvrez une nouvelle maniere de gagnez des TRON</h4>
					<p>La plateforme tp-tron permet de faire un placement de capital avec un retour sur investissement de 300 % l'année (12 mois).</p>
					<form class="hero-subscribe-from">
						<!-- <input type="text" placeholder="Entrer votre Email">
						<button class="site-btn sb-gradients">Commencez</button> -->
					</form>
				</div>
				<div class="col-md-6">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 offset-lg-6 about-text">
					<h2>Decouvrez une nouvelle maniere de gagnez des TRON</h2>
					<h5>Tp-tron est une entreprise  d'investissement en cryptomonnaie  TRON (trx).</h5>
					<p>La plateforme TP-TRON permet de faire un placement de capital avec un retour sur investissement de 300 % l'année (12 mois).  Nous sommes dotée d'expert et d'analyste risque a fin de garantir un succès sur vos investissements.</p>
					<a href="" class="site-btn sb-gradients sbg-line mt-5">Commencez</a>
				</div>
			</div>
			<div class="about-img">
				<img src="img/tron-7618003_1920.jpg" alt="">
			</div>
		</div>
	</section>
	<!-- About section end -->
	...
	<section class="features-section spad gradient-bg">
		<div class="container text-white">
			<div class="section-title text-center">
				<h2>Ce qu'il faut savoir sur TP-TRON</h2>
				<p>TRON est le moyen le plus simple d'échanger de l'argent à très faible coût.</p>
			</div>
			<div class="row">-->
				<!-- feature -->
	...
	<footer class="footer-section">
		<div class="container">
			<div class="row spad">
				...
				<!-- <img src="img/10-removebg-preview.png" alt="" width="150PX"> -->
					<p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia dese mollit anim id est laborum.</p>
					<span><!-- Link back to Djag's can't be removed. Template is licensed under CC BY 3.0. -->
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank"><tp-tron class="com"></tp-tron></a>
<!-- Link back to Djag's can't be removed. Template is licensed under CC BY 3.0. --></span>
				</div>
				...
				<div class="col-md-6 col-lg-3 footer-widget pl-lg-5 pl-3">
					...
					<div class="social">
						<a href="" class="facebook"><i class="fa fa-telegram"></i></a>
